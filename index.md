...
humandate: "Postponed, new dates TBA"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
instructor: ["Laura Wrubel", "Dolsy Smith", "Leah Richardson" ] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Dan Kerchner"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
email: ["lwrubel@gwu.edu ","dsmith@gwu.edu", "leahr@gwu.edu"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
